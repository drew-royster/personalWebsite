...
export default function Books() {
  return (
    <SimpleLayout
      title="Books I’ve been thinking about."
      intro="Not a canon, not a recommendation engine. Just a small shelf of books and the particular thoughts they left behind."
    >
